...
import { SelectionSwitcher } from "@atlas/ui/ui/components/selection-switcher";
...
export default function App() {
  ...
  return (
    ...
    <div
      ...
      className="atlas-shell flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden text-text-primary antialiased"
    >
      <SelectionSwitcher />
      ...
      <header
        className={cn(
          ...
          "bg-white/85 shadow-[0_12px_32px_rgba(41,35,70,0.08)] backdrop-blur",
        )}
        style={{
      ...
      >
        <Button
          ...
          className="text-[#1f1b2d] hover:text-[#8f95dc]"
        >
          <Menu />
        </Button>

        <AtlasLogo markClassName="h-8 w-8" />
      </header>
        ...
        <div className="flex min-h-0 min-w-0 flex-1">
          <aside
            ...
            className={cn(
              ...
              "atlas-sidebar border-r border-white/10",
              "transition-[transform] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)]",
              mobileOpen ? "translate-x-0" : "-translate-x-full",
              "lg:sticky lg:top-0 lg:ml-5 lg:my-5 lg:h-[calc(100dvh-2.5rem)] lg:max-h-[calc(100dvh-2.5rem)] lg:translate-x-0 lg:shrink-0 lg:overflow-hidden lg:rounded-[2rem] lg:border-none",
          ...
          >
            <div
              className={cn(
                "flex h-20 shrink-0 items-center gap-2",
            ...
            <nav
              className="min-h-0 w-full flex-1 overflow-y-auto overflow-x-hidden border-t border-white/10 py-3"
              aria-label={t.app.navigation}
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                ...
                >
                  <span
                    className={cn(
                      "px-5 pt-2.5 pb-1",
                      "font-sans text-display text-xs tracking-[0.12em] text-white/45",
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            <div
              className={cn(
                ...
                "px-3 sm:px-6",
                isChatRoute
                  ? "pb-0 pt-1 sm:pt-2 lg:my-5 lg:ml-5 lg:mr-5 lg:px-6 lg:pt-5"
                  : "pt-2 sm:pt-4 lg:my-5 lg:ml-5 lg:mr-5 lg:px-6 lg:pt-6",
                "lg:rounded-[2rem] lg:ring-1 lg:ring-white/80 atlas-main-surface",
            ...
            >
              ...
              <div
                className={cn(
                  "w-full min-w-0",
                  !isChatRoute &&
                    "min-h-0 flex-1 overflow-y-auto overflow-x-hidden pb-[calc(2rem+env(safe-area-inset-bottom,0px))] [scrollbar-gutter:stable] lg:pb-8",
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            "mx-3 rounded-2xl px-4 py-3",
            "font-sans text-display uppercase text-sm tracking-[0.1em]",
            "whitespace-nowrap transition-colors cursor-pointer",
            "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/70",
            isActive
              ? "bg-[#9096df]/22 text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08)]"
      ...
      >
        {({ isActive }) => (
          <>
            ...
            <span
              aria-hidden
              className="absolute inset-y-1 left-1 right-1 rounded-2xl bg-white opacity-0 pointer-events-none transition-opacity duration-200 group-hover/nav:opacity-5"
            />

            {isActive && (
              <span
                aria-hidden
                className="absolute right-3 top-1/2 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-[#cfd3ff]"
              />
            )}
          </>
        )}
