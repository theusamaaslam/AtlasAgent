 ...
 *
 * Plugins call window.__ATLAS_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ATLAS_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ATLAS_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ATLAS_PLUGIN_SDK__ = {
    ...
    // window.__ATLAS_SESSION_TOKEN__ directly.
    authedFetch,
