...
/**
 * English-only language indicator. When placed at the bottom of the sidebar
 * (next to ThemeSwitcher), pass `dropUp` so the list opens above the trigger
 * and avoids clipping below the viewport / overflow ancestors.
 */
