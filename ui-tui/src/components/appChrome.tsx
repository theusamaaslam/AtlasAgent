import { Box, type ScrollBoxHandle, stringWidth, Text } from '@atlas/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ATLAS_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ATLAS_DEV_CREDITS), lowest priority,
