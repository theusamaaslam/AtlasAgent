#!/usr/bin/env python3
"""Build the Atlas Model Catalog — a centralized JSON manifest of curated models.
...
Atlas CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Atlas release.
...
# Ensure ATLAS_HOME is set for imports that touch it at module level.
os.environ.setdefault("ATLAS_HOME", os.path.join(os.path.expanduser("~"), ".atlas"))

from atlas_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "atlas-agent repo",
            "docs": "https://github.com/theusamaaslam/AtlasAgent/tree/main/website/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
