...
DEFAULT_DATASETS = [
    ...
    "UsamaAslam/atlas-agent-megascience-sft1",
    "UsamaAslam/atlas-agent-Thinking-GLM-4.7-SFT2",
    "UsamaAslam/atlas-agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-atlas-agent"
]
