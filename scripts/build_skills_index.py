#!/usr/bin/env python3
"""Build the Atlas Skills Index — a centralized JSON catalog of all skills.
...
`atlas skills search/install` can use it without hitting the GitHub API.
...
# Ensure ATLAS_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Atlas Skills Index...", flush=True)
