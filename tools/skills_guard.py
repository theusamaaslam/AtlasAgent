...
Trust levels:
  - builtin:   Ships with Atlas. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.atlas/\.env|\~/\.atlas/\.env',
     "atlas_env_access", "critical", "exfiltration",
     "directly references Atlas secrets file"),
    ...
    (r'\.atlas/config\.yaml|\.atlas/SOUL\.md',
     "atlas_config_mod", "critical", "persistence",
     "references Atlas configuration files directly"),
...
# scan. `.skillignore` is the Atlas-native name; `.clawhubignore` is honored
