...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Atlas's web-provider config and
        ...
        # native search engine for xAI sessions instead of Atlas's
        # configured web provider (Tavily/etc.), and those results bypass
        # Atlas's tool-trace / citation plumbing (they arrive baked into the
