...
def init_agent(
    ...
    agent._cache_ttl = "5m"
    try:
        from atlas_cli.config import load_config as _load_pc_cfg
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from atlas_cli.config import load_config as _load_br_cfg
    ...
    try:
        from atlas_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from atlas_cli.config import load_config as _load_agent_config
    ...
    # Nous Atlas 3/4 are chat models, not tool-call-tuned. The interactive
    ...
    if not agent.quiet_mode and (agent.platform or "cli") != "cli":
        try:
            ...
            if _atlas_warn:
                _user_msg = (
                    "⚠ Usama Aslam Atlas 3 & 4 models are NOT agentic — they "
