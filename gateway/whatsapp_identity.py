...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ATLAS_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_atlas_dir("platforms/whatsapp/session", "whatsapp/session")
