  ...
  docs: [
            ...
            'reference/optional-skills-catalog',
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-atlas-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-atlas-agent-skill-authoring',
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/optional/devops/devops-atlas-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-atlas-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-atlas',
        'guides/use-soul-with-atlas',
        'guides/use-voice-mode-with-atlas',
        'guides/build-a-atlas-plugin',
