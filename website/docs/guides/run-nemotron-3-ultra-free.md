---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Atlas Agent"
description: "Try NVIDIA Nemotron 3 Ultra on Atlas Gateway — free June 4–18 — with day 0 support in Atlas Agent"
---

# Run Nemotron 3 Ultra free in Atlas Agent

Usama Aslam has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Atlas Gateway](https://portal.nousresearch.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Atlas Agent today.
...
When the app opens, you'll see a "Let's get you set up" screen. Click **Atlas Gateway** (marked **Recommended**). Your browser opens — create a [Atlas Gateway](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize Atlas. The app connects automatically.
...
Select **Quick Setup**. Atlas opens a browser tab and waits for you to finish the next steps.

### 3. Create a Atlas Gateway account

In the browser, create a [Atlas Gateway](https://portal.nousresearch.com) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to Atlas Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Atlas Gateway connection and that you're on the **Free** plan. In the CLI, `atlas portal info` confirms you're logged in and routing through Nous.
...
- **[Run Atlas Agent with Atlas Gateway](/guides/run-atlas-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[Atlas Gateway integration](/integrations/nous-portal)** — What's in the subscription
