...
slug: /docs
sidebar_position: 0
title: "Atlas Agent Documentation"
description: "The self-improving AI agent created by Usama Aslam. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent created by Usama Aslam. The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
To install the command-line app, follow the installation guide for your platform.
...
After installing, run `atlas setup` to choose your model provider and enable the tools you want.
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Atlas safely  |
| 🧭 **[Use MCP with Atlas](/guides/use-mcp-with-atlas)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Atlas](/guides/use-voice-mode-with-atlas)** | Hands-on setup and usage patterns for Atlas voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Atlas' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Atlas                              |
...
- **Built for capable operators** — Created by Usama Aslam. Works with OpenRouter, OpenAI, or any compatible endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, and TTS through your configured tools and providers
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Created by Usama Aslam
