...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Atlas Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Atlas Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Atlas core? Start with [Build a Atlas Plugin](../guides/build-a-atlas-plugin.md)
- Building a new built-in core tool for Atlas itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.atlas/.env
```
