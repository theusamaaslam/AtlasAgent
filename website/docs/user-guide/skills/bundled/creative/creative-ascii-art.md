...
```bash
python3 -m pyfiglet "ATLAS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ATLAS&font=Slant" | boxes -d stone
```
