...
- User wants **Atlas itself to drive a browser** → use Atlas' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
