...
```python
import sys
sys.path.insert(0, "/home/teknium/.atlas/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.atlas/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Atlas installs package this)
