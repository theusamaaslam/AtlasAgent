...
The unit tests in tests/atlas_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned atlas-writable by the
...
from atlas_cli.service_manager import S6ServiceManager
