"""Tests for the interactive session browser (`atlas sessions browse`).
...
from atlas_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """atlas sessions browse should be parseable."""
