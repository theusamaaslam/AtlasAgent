"""Tests for the specifier module + `atlas kanban specify` CLI surface.
...
from atlas_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `atlas kanban …` argparse surface directly."""
