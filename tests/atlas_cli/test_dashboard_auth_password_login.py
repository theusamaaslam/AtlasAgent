...
from atlas_cli.dashboard_auth.cookies import SESSION_AT_COOKIE, SESSION_RT_COOKIE
from atlas_cli.dashboard_auth.login_page import render_login_html
from atlas_cli.dashboard_auth.routes import _reset_password_rate_limit
...
class PasswordProvider(DashboardAuthProvider):
    ...
    def refresh_session(self, *, refresh_token: str) -> Session:
        from atlas_cli.dashboard_auth import RefreshExpiredError
...
class TestPasswordLoginRoute:
    def test_auth_login_for_password_provider_redirects_to_login_page(self, gated_app):
        resp = gated_app.get(
