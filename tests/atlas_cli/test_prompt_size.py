"""Tests for the ``atlas prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from atlas_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(atlas_home, memory_text="", user_text=""):
...
def _seed_skill(atlas_home, name, description):
    skill_dir = atlas_home / "skills" / "demo" / name
