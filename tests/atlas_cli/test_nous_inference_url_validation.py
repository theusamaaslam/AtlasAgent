"""Regression tests for Atlas Gateway inference_base_url host-allowlist validation.
...
class TestCallSiteWiring:
    ...
    def _read_auth_source(self):
        import atlas_cli.auth as _auth_mod
    ...
    def test_proxy_adapter_also_validates(self):
        ...
        boundary."""
        from pathlib import Path
        import atlas_cli.proxy.adapters.nous_portal as _nous_adapter
