"""Tests for `atlas curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import atlas_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ATLAS_HOME with real agent-created skills on disk."""
    home = tmp_path / ".atlas"
    skills = home / "skills"
    ...
    from atlas_cli import curator as curator_cli
