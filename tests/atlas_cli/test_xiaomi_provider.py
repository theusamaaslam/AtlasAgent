...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from atlas_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ATLAS_OVERLAYS
        overlay = ATLAS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify atlas doctor recognizes Xiaomi env vars."""
