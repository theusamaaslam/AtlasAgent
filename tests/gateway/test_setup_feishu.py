"""Tests for _setup_feishu() in atlas_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("atlas_cli.config.save_env_value", side_effect=mock_save), \
         patch("atlas_cli.config.get_env_value", side_effect=mock_get), \
         patch("atlas_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("atlas_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("atlas_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("atlas_cli.cli_output.print_header"), \
         patch("atlas_cli.cli_output.print_info"), \
         patch("atlas_cli.cli_output.print_success"), \
         patch("atlas_cli.cli_output.print_warning"), \
         patch("atlas_cli.cli_output.print_error"), \
