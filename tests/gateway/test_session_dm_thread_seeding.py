...
def store(tmp_path, monkeypatch):
    ...
    ~/.atlas/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at atlas_state import time, before pytest's ATLAS_HOME monkeypatch
    fires — the autouse fixture's ATLAS_HOME override doesn't help here.)
    """
    import atlas_state
