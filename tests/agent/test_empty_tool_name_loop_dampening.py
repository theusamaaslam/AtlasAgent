...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated ATLAS_HOME, yield (agent, helpers)."""
    ...
    test_home = tempfile.mkdtemp(prefix="atlas_e2e_47967_")
    os.makedirs(os.path.join(test_home, ".atlas"))
    prev_home = os.environ.get("ATLAS_HOME")
    os.environ["ATLAS_HOME"] = os.path.join(test_home, ".atlas")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["ATLAS_HOME"] = prev_home
