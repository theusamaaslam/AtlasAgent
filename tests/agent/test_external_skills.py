...
class TestGetExternalSkillsDirs:
    ...
    def test_nonexistent_dir_skipped(self, atlas_home):
    ...
    def test_duplicate_dirs_deduplicated(self, atlas_home, external_skills_dir):
        (atlas_home / "config.yaml").write_text(
            f"skills:\n  external_dirs:\n    - {external_skills_dir}\n    - {external_skills_dir}\n"
        )
        with patch.dict(os.environ, {"ATLAS_HOME": str(atlas_home)}):
    ...
    def test_local_skills_dir_excluded(self, atlas_home):
    ...
    def test_no_config_file(self, atlas_home):
    ...
    def test_string_value_converted_to_list(self, atlas_home, external_skills_dir):
        (atlas_home / "config.yaml").write_text(
