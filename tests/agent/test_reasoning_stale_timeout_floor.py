...
thinking phase.  Atlas's default cloud-stream stale detector
(``ATLAS_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ATLAS_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
