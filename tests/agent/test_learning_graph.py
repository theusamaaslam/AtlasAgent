...
def test_atlas_meta_tolerates_non_dict():
    assert learning_graph._atlas_meta({"metadata": "junk"}) == {}
    assert learning_graph._atlas_meta({"metadata": {"atlas": "junk"}}) == {}
    assert learning_graph._atlas_meta({"metadata": {"atlas": {"category": "x"}}}) == {"category": "x"}
