...
class TestClassifySandboxMirrorTarget:
    ...
    def test_path_outside_sandbox_returns_none(self, tmp_path):
        """A plain Atlas path is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
    ...
    def test_sandboxes_segment_without_home_atlas_returns_none(self, tmp_path):
        """A ``sandboxes/`` directory unrelated to Atlas-state mirroring (e.g.
    ...
    def test_sandboxes_segment_with_home_but_no_atlas_returns_none(self, tmp_path):
        """``sandboxes/<backend>/<task>/home/anything-not-atlas`` is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
    ...
    def test_truncated_sandbox_path_returns_none(self, tmp_path):
        """``…/sandboxes/<backend>/<task>`` without ``home/.atlas/<thing>`` is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
