...
Built for [Atlas Agent](https://github.com/theusamaaslam/AtlasAgent). Usable in any coding agent. Canonical source lives here; synced to [`theusamaaslam/AtlasAgent/skills/creative/ascii-video`](https://github.com/theusamaaslam/AtlasAgent/tree/main/skills/creative/ascii-video) via PR.
