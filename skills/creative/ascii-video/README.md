...
Built for [Atlas Agent](https://github.com/UsamaAslam/atlas-agent). Usable in any coding agent. Canonical source lives here; synced to [`UsamaAslam/atlas-agent/skills/creative/ascii-video`](https://github.com/UsamaAslam/atlas-agent/tree/main/skills/creative/ascii-video) via PR.
