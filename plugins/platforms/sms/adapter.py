...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Atlas gateway adapter.

    Each inbound phone number gets its own Atlas session (multi-tenant).
...
# static dict in atlas_cli/gateway.py, and the _send_sms dispatch in
