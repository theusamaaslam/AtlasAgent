...
required — uses aiohttp which is already a Atlas dependency.
...
def interactive_setup() -> None:
    ...
    ``atlas_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Atlas delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # atlas_cli/setup.py::_setup_mattermost function.
