...
Config: ~/.atlas/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.atlas/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_atlas_home()`` helper (ATLAS_HOME-aware and
...
RULES_FILE = get_atlas_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_atlas_home() / "feishu_comment_pairing.json"
