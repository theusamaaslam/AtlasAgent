...
cd apps/desktop
XCURSOR_SIZE=24 ATLAS_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/atlas-typing
# → /tmp/atlas-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/atlas-typing.before.heapsnapshot
# → /tmp/atlas-typing.after.heapsnapshot
```
