...
export interface PetInfo {
  ...
  // the Atlas "run" activity state uses the in-place running row).
 ...
 * ATLAS_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'atlas.desktop.pet-roam.v1'
