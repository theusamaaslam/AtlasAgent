...
import type { AtlasGitWorktree, AtlasRepoStatus } from '@/global'
...
export const $repoStatus = atom<AtlasRepoStatus | null>(null)
...
export const $repoWorktrees = atom<AtlasGitWorktree[]>([])
