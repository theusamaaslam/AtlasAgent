...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/atlas'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('atlas:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('atlas:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Atlas to
