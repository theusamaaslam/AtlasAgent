...
import type { ProjectInfo, SessionInfo } from '@/atlas'
 ...
 * repo shows its branches/worktrees even when they have no Atlas sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: AtlasGitWorktree[]
): SidebarSessionGroup[] {
