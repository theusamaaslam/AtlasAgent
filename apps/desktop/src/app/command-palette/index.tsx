...
import { getAtlasConfigRecord, listAllProfileSessions } from '@/atlas'
...
// Atlas session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-atlas',
            keywords: ['update', 'upgrade', 'atlas', 'version', 'system', 'restart'],
            label: cc.updateAtlas,
