 ...
 * log inline — the GUI equivalent of the install step `atlas tools` runs
...
/**
 * Backend model catalog — the GUI counterpart of the model picker `atlas
...
export function ToolsetConfigPanel({ toolset, onConfiguredChange }: ToolsetConfigPanelProps) {
  ...
  // panel highlighted the first keyless provider (e.g. Atlas Gateway) even when
