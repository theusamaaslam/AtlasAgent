...
import type { AtlasConfigRecord, ToolsetInfo } from '@/types/atlas'
...
export function getNested(obj: AtlasConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AtlasConfigRecord, path: string, value: unknown): AtlasConfigRecord {
...
function personalityOptions(config: AtlasConfigRecord): string[] {
