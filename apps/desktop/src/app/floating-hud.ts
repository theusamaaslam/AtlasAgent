...
// hairline `--stroke-atlas` paired with the soft `--shadow-atlas` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-atlas) bg-(--ui-chat-bubble-background) shadow-atlas [-webkit-app-region:no-drag]'
