...
export const en: Translations = {
  ...
  boot: {
    ready: 'Atlas Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Atlas settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingAtlasDesktop: 'Starting Atlas Desktop…'
    },
    errors: {
      backgroundExited: 'Atlas background process exited.',
      backgroundExitedDuringStartup: 'Atlas background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Atlas backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Atlas Desktop.',
    ...
    native: {
      ...
      inputBody: 'Atlas is waiting for your response.',
      turnDoneTitle: 'Atlas finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Atlas defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Atlas is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Atlas asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Atlas was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Atlas follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Atlas is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Atlas, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Atlas checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Atlas configuration...',
    ...
    gateway: {
      ...
      intro:
        'Atlas Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Atlas backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ATLAS_DESKTOP_REMOTE_URL and ATLAS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Atlas backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Atlas backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /atlas.',
      ...
      restartingMessage: 'Atlas Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Atlas ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Atlas runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Atlas Gateway subscription — sign in to Atlas Gateway to activate.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via atlas curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Atlas builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Atlas to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Atlas to generate pets.',
      backgroundHint: 'You can close this — Atlas will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Atlas desktop' },
    ...
    atlasActiveSessions: (version, count) => `Atlas ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@atlas:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Atlas environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Atlas will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Atlas backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Atlas. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Atlas...',
    placeholderReconnecting: 'Reconnecting to Atlas…',
    ...
    attachUrlDesc: 'Atlas will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Atlas to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Atlas…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Atlas…',
    ...
    unsupportedMessage: 'This version of Atlas can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Atlas is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Atlas backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Atlas from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Atlas will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Atlas desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Atlas updater takes over in its own window and reopens Atlas automatically when it’s done. Please don’t reopen Atlas yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Atlas reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Atlas reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Atlas needs a one-time install',
    ...
    settingUpTitle: 'Setting up Atlas Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Atlas CLI or desktop instance is running. Stop any running Atlas instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Atlas',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Atlas at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Atlas connects automatically',
    ...
    authorizeThere: 'Authorize Atlas there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Atlas there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Atlas Gateway subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Atlas Desktop v${version}`,
      ...
      gatewayTitle: 'Atlas inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Atlas will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Atlas is restarting...',
      askRestart: 'Ask Atlas to restart the server',
      lookingRestart: taskId => `Atlas is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Atlas is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Atlas finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Atlas could not restart the server.',
      stillWorking:
        'Atlas is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Atlas is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Atlas gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.atlas/config.yaml). Atlas won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Atlas needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Atlas needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Atlas Desktop to use Save Image.',
    restartToSaveImages: 'Restart Atlas Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `atlas gateway` running?'
    }
  },
