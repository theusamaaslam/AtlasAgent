...
function installDesktopBridge(partial: Partial<Window['atlasDesktop']> = {}) {
  desktopWindow.atlasDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['atlasDesktop']
}
...
afterEach(() => {
  ...
  if (initialAtlasDesktop) {
    desktopWindow.atlasDesktop = initialAtlasDesktop
  } else {
    delete desktopWindow.atlasDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['atlasDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['atlasDesktop']['openExternal'] })
