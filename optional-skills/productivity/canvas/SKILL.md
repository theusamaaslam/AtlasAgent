...
4. Name the token (e.g., "Atlas Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${ATLAS_HOME:-~/.atlas}/.env`:
...
```bash
CANVAS="python $ATLAS_HOME/skills/productivity/canvas/scripts/canvas_api.py"
