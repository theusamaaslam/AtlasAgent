...
def _has_atlas_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ATLAS_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-AtlasHome", str(get_atlas_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = atlas_subprocess_env(inherit_credentials=False)
