"""
Atlas CLI - Unified command-line interface for Atlas Agent.

Provides subcommands for:
- atlas chat          - Interactive chat (same as ./atlas)
- atlas gateway       - Run gateway in foreground
- atlas gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `atlas setup` on a fresh Pi.
    ...
    atlas_cli/stdio.py::configure_windows_stdio() runs later from the entry
