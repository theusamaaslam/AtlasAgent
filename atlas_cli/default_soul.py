"""Default SOUL.md template seeded into ATLAS_HOME on first run."""
...
_LEGACY_TEMPLATE_SOULS = (
    (
        "You are Atlas Agent, an intelligent AI assistant created by " "Nous" " Research. "
        "You are helpful, knowledgeable, and direct. You assist users with a wide "
        "range of tasks including answering questions, writing and editing code, "
        "analyzing information, creative work, and executing actions via your tools. "
        "You communicate clearly, admit uncertainty when appropriate, and prioritize "
    ...
    (
        "You are Atlas Agent, an intelligent AI assistant created by " "Nous" " Research. "
        "I help with a wide range of tasks -- answering questions, writing and "
        "editing code, analyzing information, creative work, and executing actions "
        "via tools."
    ),
    (
        "I'm Atlas Agent, an AI assistant created by " "Nous" " Research. "
        "I help with a wide range of tasks -- answering questions, writing and "
        "editing code, analyzing information, creative work, and executing actions "
        "via tools."
    ),
    (
        ...
        "Edit this to customize how Atlas communicates with you.\n"
        "\n"
        "Examples:\n"
...
def replace_legacy_creator_branding(text: str) -> str:
    """Replace legacy creator attribution in SOUL/persona text."""
    return (
        text.replace("created by " "Nous" " Research", "created by Usama Aslam")
        .replace("Created by " "Nous" " Research", "Created by Usama Aslam")
        .replace("by " "Nous" " Research", "by Usama Aslam")
    )
