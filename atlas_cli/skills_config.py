"""
Skills configuration for Atlas Agent.
`atlas skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.atlas/config.yaml under:
...
from atlas_cli.config import cfg_get, load_config, save_config
from atlas_cli.colors import Colors, color
from atlas_cli.platforms import PLATFORMS as _PLATFORMS
