"""Atlas CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.atlas/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Atlas Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Atlas "       # Response box header label
...
.. code-block:: python
    ...
    from atlas_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Atlas Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.atlas/skins/
...
Drop a YAML file in ``~/.atlas/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ATLAS_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ATLAS_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Atlas Command — charcoal, jade, amber, and coral",
        "colors": {
            "banner_border": "#2E423D",
            "banner_title": "#66E6B8",
            "banner_accent": "#F6C76F",
            "banner_dim": "#6D827C",
            "banner_text": "#D7FFF1",
            "ui_accent": "#66E6B8",
            "ui_label": "#F6C76F",
            ...
            "prompt": "#D7FFF1",
            "input_rule": "#2E423D",
            "response_border": "#66E6B8",
            "status_bar_bg": "#0F1413",
            "status_bar_text": "#D7FFF1",
            "status_bar_strong": "#66E6B8",
            "status_bar_dim": "#6D827C",
            "status_bar_good": "#66E6B8",
            "status_bar_warn": "#F6C76F",
            "status_bar_bad": "#FF9E64",
            "status_bar_critical": "#FF7A59",
            "voice_status_bg": "#0F1413",
            "selection_bg": "#24322E",
            "completion_menu_bg": "#0F1413",
            "completion_menu_current_bg": "#1D2825",
            "completion_menu_meta_bg": "#141B19",
            "completion_menu_meta_current_bg": "#24322E",
            "session_label": "#F6C76F",
            "session_border": "#2E423D",
        },
        "spinner": {
            "waiting_faces": ["[::]", "[<>]", "[//]", "[##]"],
            "thinking_faces": ["[::]", "[<>]", "[//]", "[##]"],
            "thinking_verbs": [
                "mapping", "routing", "linking context", "checking tools",
                "shaping the answer", "syncing sessions",
            ],
            "wings": [
                ["<", ">"],
                ["[", "]"],
        ...
        "branding": {
            ...
            "welcome": "Atlas Command is online. Type your message or /help for commands.",
            "goodbye": "Atlas session closed.",
            "response_label": " Atlas ",
            "prompt_symbol": ">",
            "help_header": "Atlas Command",
        },
        "tool_prefix": "|",
        "banner_logo": """[bold #8F95DC] █████╗ ████████╗██╗      █████╗ ███████╗       █████╗  ██████╗ ███████╗███╗   ██╗████████╗[/]
[bold #8F95DC]██╔══██╗╚══██╔══╝██║     ██╔══██╗██╔════╝      ██╔══██╗██╔════╝ ██╔════╝████╗  ██║╚══██╔══╝[/]
[#BFC4ED]███████║   ██║   ██║     ███████║███████╗      ███████║██║  ███╗█████╗  ██╔██╗ ██║   ██║   [/]
[#FFFFFF]██║  ██║   ██║   ███████╗██║  ██║███████║      ██║  ██║╚██████╔╝███████╗██║ ╚████║   ██║   [/]
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "branding": {
            "agent_name": "Atlas Agent",
            "welcome": "Welcome to Atlas Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Atlas ",
            "prompt_symbol": "❯",
            "help_header": "[?] Available Commands",
