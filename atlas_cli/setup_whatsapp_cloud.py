...
Entry point: ``atlas whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``atlas_cli/main.py``).
...
Atlas gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Atlas to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Atlas needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Atlas gateway in another terminal:")
    print("         atlas gateway")
    print()
    ...
    print()
    print("  Docs: https://atlas-agent.nousresearch.com/docs/user-guide/")
