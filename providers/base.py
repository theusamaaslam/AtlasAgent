...
def _profile_user_agent() -> str:
    """Return a ``atlas-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from atlas_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"atlas-cli/{_ver}"
    except Exception:
        return "atlas-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # atlas-cli UA so the catalog endpoint is reachable.
